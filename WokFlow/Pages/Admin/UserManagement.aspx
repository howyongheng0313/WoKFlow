...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="max-w-[1400px] mx-auto px-6 md:px-12 py-8 mt-4">
        ...
        <!-- Filters -->
        <asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnSearch" CssClass="flex flex-col md:flex-row gap-3 mb-4">
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-200">
                        ...
                        <th class="text-left py-4 px-8 text-sm font-bold text-gray-800">Role</th>
                        <th class="text-left py-4 px-8 text-sm font-bold text-gray-800">Joined Date</th>
                    ...
                    <asp:Repeater ID="rptUsers" runat="server" OnItemCommand="rptUsers_ItemCommand">
                        <ItemTemplate>
                            <tr class="border-b border-gray-100 hover:bg-[#FFF8F0] transition-colors">
                                ...
                                <td class="py-5 px-8 text-sm text-gray-500"><%# Eval("Role") %></td>
                                <td class="py-5 px-8 text-sm text-gray-500"><%# ((DateTime)Eval("JoinedDate")).ToString("yyyy-MM-dd") %></td>
                                ...
                                <td class="py-5 px-4">
                                    <div class="relative inline-block">
                                        ...
                                        <div class="kebab-menu hidden fixed z-50 w-36 bg-white rounded-xl shadow-lg border border-gray-100 py-1">
                                            <asp:LinkButton ID="lnkBan" runat="server" CommandName="Ban" CommandArgument='<%# Eval("UserId") %>'
                                            ...
                                            <asp:LinkButton ID="lnkRecover" runat="server" CommandName="Recover" CommandArgument='<%# Eval("UserId") %>'
                                                Visible='<%# Eval("Status").ToString() == "Banned" %>'
                                                CssClass="block w-full text-left px-4 py-2 text-sm text-green-600 hover:bg-green-50 transition-colors">Recover</asp:LinkButton>
                                        </div>
                                    </div>
                                </td>
                            </tr>
