...
<header class="flex items-center justify-between px-6 py-4 md:px-12 max-w-[1400px] mx-auto w-full relative z-20">
    <div class="glass-panel rounded-full px-6 py-3 w-full flex items-center justify-between">
        <!-- Logo -->
        <a href="<%: ResolveUrl("~/Pages/Admin/UserManagement.aspx") %>" class="flex items-center gap-2 no-underline">
        ...
        <nav class="hidden md:flex items-center gap-10">
            ...
            <div class="relative" id="adminUserDropdown">
                <button type="button" onclick="toggleAdminDropdown('adminUserMenu')"
                ...
                <div id="adminUserMenu" class="hidden absolute top-full left-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden z-50 dropdown-menu">
